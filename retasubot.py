...
gye = LINE()
gye.log("Et6qM8UeTce5bGsZG4te.ee6vQU/1ppqr93nt9QLUZG.b5fsCbuxW7zZRtrK5U/74k/53Abd5dWPxfdtLy9bL9I=" + str(gye.authToken))
channelToken = gye.getChannelResult()
gye.log("Et6qM8UeTce5bGsZG4te.ee6vQU/1ppqr93nt9QLUZG.b5fsCbuxW7zZRtrK5U/74k/53Abd5dWPxfdtLy9bL9I=" + str(channelToken))

ais = LINE()
ais.log("Etska0dbjsHvPgZKwmj9.EikS5M3O+L4fOqxjjVgLsq.KlWfvmGVaXdM0yvKM8WGKARpcbAbiKVF9yORPt8QBJw=" + str(ais.authToken))
channelToken = ais.getChannelResult()
ais.log("Etska0dbjsHvPgZKwmj9.EikS5M3O+L4fOqxjjVgLsq.KlWfvmGVaXdM0yvKM8WGKARpcbAbiKVF9yORPt8QBJw=" + str(channelToken))

ki2 = LINE()
ki2.log("EtQsqzdJMWn73m72Gup0.OdjJmVnqXLeaZxpJzxDMOa.Z+6ApCht+0H1NeyX50QMD0Yq8oIhYyJ14Yg2yoM/tfc=" + str(ki2.authToken))
channelToken = ki2.getChannelResult()
ki2.log("EtQsqzdJMWn73m72Gup0.OdjJmVnqXLeaZxpJzxDMOa.Z+6ApCht+0H1NeyX50QMD0Yq8oIhYyJ14Yg2yoM/tfc=" + str(channelToken))

ki3 = LINE()
ki3.log("EtDOOeYj4Rvl5PVfOEaa.ETpCu8czFapUIJQDqIA82G.tcOaI+VmHhWwMbyDL/7yXupWfdIvUJh80yWzu/UJXp8=" + str(ki3.authToken))
channelToken = ki3.getChannelResult()
ki3.log("EtDOOeYj4Rvl5PVfOEaa.ETpCu8czFapUIJQDqIA82G.tcOaI+VmHhWwMbyDL/7yXupWfdIvUJh80yWzu/UJXp8=" + str(channelToken))

ki4 = LINE()
ki4.log("EtWyu42OHWKSaxPHY3yd.jTri3xzV4E2Z1xvWxjTrRq.s1oy5gbYMT2haZV7l6yzV0bp5gONcnu+bGSSJ1mbT0c=" + str(gye.authToken))
channelToken = ki4.getChannelResult()
ki4.log("EtWyu42OHWKSaxPHY3yd.jTri3xzV4E2Z1xvWxjTrRq.s1oy5gbYMT2haZV7l6yzV0bp5gONcnu+bGSSJ1mbT0c=" + str(channelToken))
...
def helptexttospeech():
    helpTextToSpeech =   "╭════════╬♥╬════════╮" + "\n" + \
                  ...
                  "║͜͡☆➣ Join link on/off" + "\n" + \
                  "║͜͡☆➣ GroupCreator (グループ作成者）" + "\n" + \
                  "║͜͡☆➣ GroupId　（グループID）" + "\n" + \
                  "║͜͡☆➣ GroupName　（グループ名）" + "\n" + \
                  "║͜͡☆➣ GroupPicture　（グループ画像）" + "\n" + \
                  "║͜͡☆➣ GroupList　（グループリスト）" + "\n" + \
                  "║͜͡☆➣ GroupMemberList　（グループメンバーリスト）" + "\n" + \
                  "║͜͡☆➣ GroupInfo　（グループ情報）" + "\n" + \
                  "║͜͡☆➣ ウラル" + "\n" + \
                  "║͜͡☆➣ ウラル on/off" + "\n" + \
                  "║͜͡☆➣ Mimic on" + "\n" + \
...
#-------------------------------------------------------------------------------
                ...
                elif text.lower() == 'レタスは？':
                        gye.sendMessage(msg.to,"おいしいヨ1")
                        ais.sendMessage(msg.to,"おいしいヨ2")
                        ki2.sendMessage(msg.to,"おいしいヨ3")
                        ki3.sendMessage(msg.to,"おいしいヨ4")
                        ki4.sendMessage(msg.to,"おいしいヨ5")
                        gye.sendMessage(msg.to,"やっぱりレタスは美味しいね！")

                elif text.lower() == 'ブラックリスト追加':
                        settings["wblacklist"] = True
                        gye.sendMessage(msg.to,"Send Contact")

                elif msg.text in ["ブラックリスト消去"]:
                        settings["dblacklist"] = True
                        gye.sendMessage(msg.to,"Send Contact")
#-------------------------------------------------------------------------------
                elif text.lower() == 'ブラックリスト':
...
#==============================================================================#
                    ...
                    for a in range(k+1):
                        ...
                        for i in group.members[a*100 : (a+1)*100]:
                            ...
                            mkmk = "mk:"
                            txt += u'@Alin \n'
                        gye.sendMessage(to,mkmk, text=txt, contentMetadata={u'MENTION': json.dumps({'MENTIONEES':b})}, contentType=0)
                        gye.sendMessage(to, "Total {} Mention".format(str(len(nama))))
                elif text.lower() == '既読セット on':
